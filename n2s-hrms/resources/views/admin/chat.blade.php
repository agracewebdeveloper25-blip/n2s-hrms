...
<html lang="en" dir="ltr" data-startbar="dark" data-bs-theme="light">
    ...
    <head>
        ...
        <meta charset="utf-8" />
                <title>Chat | Approx - Admin & Dashboard Template</title>
                                ...
                                <div class="chat-search p-3">
                                    <div class="p-1 bg-secondary-subtle rounded rounded-pill">
                                        <div class="input-group">
                                          ...
                                          <input type="search" placeholder="Searching.." aria-describedby="button-addon2" class="form-control border-0 bg-transparent">
                                        </div>
                                    </div>
                                </div><!--end chat-search-->
                                                        ...
                                                        <a href="" class="">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                                                    ...
                                                                    <p class="text-muted mb-0"><span class="text-primary fs-12">Typing...</span>
